...
$(function(){function t(t,e,n){return Math.floor(Math.sqrt(Math.pow(e-(t.offset().left+t.width()/2),2)+Math.pow(n-(t.offset().top+t.height()/2),2)))}console.log("Hex o’clock"),console.log("https://github.com/idleberg.com/hex-o-clock"),css=getData(),google_font=css.font.replace(" ","+"),font=getFontMetrics(css.font),$("#valueFontSize").text(css["font-size"]+"em"),$("#valueInvert").text(css["invert-percentage"]+"%"),$("#valueHue").text(css["hue-rotate"]+"°"),$("#valueSaturate").text(css.saturate+"%"),$(".google-font").prop("href","http://fonts.googleapis.com/css?family="+google_font),$("#inputFontFamily").text(css.font),$("#inputFontSize").val(css["font-size"]),$("#inputInvert").val(css["invert-percentage"]),$("#inputHue").val(css["hue-rotate"]),$("#inputSaturate").val(css.saturate),$("#inputFontFamily").val(css.font),$("#hex").css("font-size",css["font-size"]+"em"),$("#hex").css({"font-family":font.family+', Menlo, "Courier New", monospace',"font-weight":font.weight}),$("div.background").css("-webkit-filter","invert("+css["invert-percentage"]+"%) hue-rotate("+css["hue-rotate"]+"deg) saturate("+css.saturate+"%)"),$("body").fadeIn("slow"),$("#inputFontSize").bind("click mousemove keydown",function(){changeFont()}),$(".filter, .filter-label").bind("click mousemove keydown",function(){changeFilter()}),$("#inputFontFamily").on("input",function(){changeFont()}),$("#labelFontSize").dblclick(function(){$("#valueFontSize").text("9em"),invert=$("#inputFontSize").val(9),changeFont()}),$("#labelInvert").dblclick(function(){$("#valueInvert").text("0%"),invert=$("#inputInvert").val(0),changeFilter()}),$("#labelHue").dblclick(function(){$("#valueHue").text("0°"),hue_rotate=$("#inputHue").val(0),changeFilter()}),$("#labelSaturate").dblclick(function(){$("#valueSaturate").text("100%"),saturate=$("#inputSaturate").val(100),changeFilter()}),$("#labelFontFamily").dblclick(function(){saturate=$("#inputFontFamily").val("Lato:100"),changeFont()}),$(".close-menu").click(function(){$(".navmenu").offcanvas("hide")}),$(".toggle-menu").delay(5e3).fadeOut(5e3),$(document).mouseleave(function(){$(".toggle-menu").stop().fadeOut(2e3)});var e,n,o,a=$("#sweetspot");$(document).mousemove(function(i){e=i.pageX,n=i.pageY,o=t(a,e,n),500>=o?$(".toggle-menu").stop().fadeIn(100):$(".toggle-menu").stop().fadeOut(5e3)}),$(".modal").on("show.bs.modal",function(){var t;t=this,$(".modal").each(function(){this!==t&&$(this).modal("hide")})})});