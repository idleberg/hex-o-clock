...
+function(t){"use strict";var s=function(e,i){this.$element=t(e),this.options=t.extend({},s.DEFAULTS,i),this.state=null,this.placement=null,this.options.recalc&&(this.calcClone(),t(window).on("resize",t.proxy(this.recalc,this))),this.options.autohide&&t(document).on("click",t.proxy(this.autohide,this)),this.options.toggle&&this.toggle(),this.options.disablescrolling&&(this.options.disableScrolling=this.options.disablescrolling,delete this.options.disablescrolling)};s.DEFAULTS={toggle:!0,placement:"auto",autohide:!0,recalc:!0,disableScrolling:!0},s.prototype.offset=function(){switch(this.placement){case"left":case"right":return this.$element.outerWidth();case"top":case"bottom":return this.$element.outerHeight()}},s.prototype.calcPlacement=function(){function s(t,s){if("auto"===n.css(s))return t;if("auto"===n.css(t))return s;var e=parseInt(n.css(t),10),i=parseInt(n.css(s),10);return e>i?s:t}if("auto"!==this.options.placement)return void(this.placement=this.options.placement);this.$element.hasClass("in")||this.$element.css("visiblity","hidden !important").addClass("in");var e=t(window).width()/this.$element.width(),i=t(window).height()/this.$element.height(),n=this.$element;this.placement=e>=i?s("left","right"):s("top","bottom"),"hidden !important"===this.$element.css("visibility")&&this.$element.removeClass("in").css("visiblity","")},s.prototype.opposite=function(t){switch(t){case"top":return"bottom";case"left":return"right";case"bottom":return"top";case"right":return"left"}},s.prototype.getCanvasElements=function(){var s=this.options.canvas?t(this.options.canvas):this.$element,e=s.find("*").filter(function(){return"fixed"===t(this).css("position")}).not(this.options.exclude);return s.add(e)},s.prototype.slide=function(s,e,i){if(!t.support.transition){var n={};return n[this.placement]="+="+e,s.animate(n,350,i)}var a=this.placement,o=this.opposite(a);s.each(function(){"auto"!==t(this).css(a)&&t(this).css(a,(parseInt(t(this).css(a),10)||0)+e),"auto"!==t(this).css(o)&&t(this).css(o,(parseInt(t(this).css(o),10)||0)-e)}),this.$element.one(t.support.transition.end,i).emulateTransitionEnd(350)},s.prototype.disableScrolling=function(){var s=t("body").width(),e="padding-"+this.opposite(this.placement);if(void 0===t("body").data("offcanvas-style")&&t("body").data("offcanvas-style",t("body").attr("style")||""),t("body").css("overflow","hidden"),t("body").width()>s){var i=parseInt(t("body").css(e),10)+t("body").width()-s;setTimeout(function(){t("body").css(e,i)},1)}},s.prototype.show=function(){if(!this.state){var s=t.Event("show.bs.offcanvas");if(this.$element.trigger(s),!s.isDefaultPrevented()){this.state="slide-in",this.calcPlacement();var e=this.getCanvasElements(),i=this.placement,n=this.opposite(i),a=this.offset();-1!==e.index(this.$element)&&(t(this.$element).data("offcanvas-style",t(this.$element).attr("style")||""),this.$element.css(i,-1*a),this.$element.css(i)),e.addClass("canvas-sliding").each(function(){void 0===t(this).data("offcanvas-style")&&t(this).data("offcanvas-style",t(this).attr("style")||""),"static"===t(this).css("position")&&t(this).css("position","relative"),"auto"!==t(this).css(i)&&"0px"!==t(this).css(i)||"auto"!==t(this).css(n)&&"0px"!==t(this).css(n)||t(this).css(i,0)}),this.options.disableScrolling&&this.disableScrolling();var o=function(){"slide-in"==this.state&&(this.state="slid",e.removeClass("canvas-sliding").addClass("canvas-slid"),this.$element.trigger("shown.bs.offcanvas"))};setTimeout(t.proxy(function(){this.$element.addClass("in"),this.slide(e,a,t.proxy(o,this))},this),1)}}},s.prototype.hide=function(){if("slid"===this.state){var s=t.Event("hide.bs.offcanvas");if(this.$element.trigger(s),!s.isDefaultPrevented()){this.state="slide-out";var e=t(".canvas-slid"),i=(this.placement,-1*this.offset()),n=function(){"slide-out"==this.state&&(this.state=null,this.placement=null,this.$element.removeClass("in"),e.removeClass("canvas-sliding"),e.add(this.$element).add("body").each(function(){t(this).attr("style",t(this).data("offcanvas-style")).removeData("offcanvas-style")}),this.$element.trigger("hidden.bs.offcanvas"))};e.removeClass("canvas-slid").addClass("canvas-sliding"),setTimeout(t.proxy(function(){this.slide(e,i,t.proxy(n,this))},this),1)}}},s.prototype.toggle=function(){"slide-in"!==this.state&&"slide-out"!==this.state&&this["slid"===this.state?"hide":"show"]()},s.prototype.calcClone=function(){this.$calcClone=this.$element.clone().html("").addClass("offcanvas-clone").removeClass("in").appendTo(t("body"))},s.prototype.recalc=function(){if("none"!==this.$calcClone.css("display")&&("slid"===this.state||"slide-in"===this.state)){this.state=null,this.placement=null;var s=this.getCanvasElements();this.$element.removeClass("in"),s.removeClass("canvas-slid"),s.add(this.$element).add("body").each(function(){t(this).attr("style",t(this).data("offcanvas-style")).removeData("offcanvas-style")})}},s.prototype.autohide=function(s){0===t(s.target).closest(this.$element).length&&this.hide()};var e=t.fn.offcanvas;t.fn.offcanvas=function(e){return this.each(function(){var i=t(this),n=i.data("bs.offcanvas"),a=t.extend({},s.DEFAULTS,i.data(),"object"==typeof e&&e);n||i.data("bs.offcanvas",n=new s(this,a)),"string"==typeof e&&n[e]()})},t.fn.offcanvas.Constructor=s,t.fn.offcanvas.noConflict=function(){return t.fn.offcanvas=e,this},t(document).on("click.bs.offcanvas.data-api","[data-toggle=offcanvas]",function(s){var e,i=t(this),n=i.attr("data-target")||s.preventDefault()||(e=i.attr("href"))&&e.replace(/.*(?=#[^\s]+$)/,""),a=t(n),o=a.data("bs.offcanvas"),l=o?"toggle":i.data();s.stopPropagation(),o?o.toggle():a.offcanvas(l)})}(window.jQuery);
function getData(){var t=[];if(t=setDefaults(),use_storage()){debug===!0&&console.info("	localStorage is available\n");for(var e=0;e<localStorage.length;e++){var o=localStorage.key(e),a=localStorage.getItem(o);t[o]=a,debug===!0&&console.log("	"+o+"="+a)}}return t}function setDefaults(){var t=[];return t.font="Lato:100",t["font-size"]="12",t.invert="0",t.hue="0",t.saturate="100",t.brightness="100",t.contrast="100",t}function getFontMetrics(t){var e=[];return t.indexOf(":")>-1?(font_array=t.split(":"),e.family=font_array[0],e.weight=font_array[1],e.google=t.replace(" ","+")):(e.family=t,e.weight="inherit",e.google=t.replace(" ","+")),e}function changeFilter(){invert=$("#input-invert").val(),hue=$("#input-hue").val(),saturate=$("#input-saturate").val(),brightness=$("#input-brightness").val(),contrast=$("#input-contrast").val(),debug===!0&&(console.log("Invert percentage changed to:	"+invert),console.log("Hue rotate changed to:	"+hue),console.log("Saturation changed to:	"+saturate),console.log("Brightness changed to:	"+brightness),console.log("Contrast changed to:	"+contrast)),$("div.background").css("-webkit-filter","invert("+invert+"%) hue-rotate("+hue+"deg) saturate("+saturate+"%) brightness("+brightness+"%) contrast("+contrast+"%)"),$("#value-invert").text(invert+"%"),$("#value-hue").text(hue+"°"),$("#value-saturate").text(saturate+"%"),$("#value-brightness").text(brightness+"%"),$("#value-contrast").text(contrast+"%"),localStorage.setItem("invert",invert),localStorage.setItem("hue",hue),localStorage.setItem("saturate",saturate),localStorage.setItem("brightness",brightness),localStorage.setItem("contrast",contrast)}function changeFont(){size=$("#input-font-size").val(),family=$("#input-font-family").val(),font=getFontMetrics(family),$(".google-font").delay(1500).queue(function(t){$(this).prop("href","http://fonts.googleapis.com/css?family="+font.google),t()}),debug===!0&&(console.log("Font-family changed to:	"+family),console.log("Font-size changed to:	"+size)),$("#hex").css("font-size",size+"em"),$("#hex").css({"font-family":font.family+', Menlo, "Courier New", monospace',"font-weight":font.weight}),$("#value-font-size").text(size+"em"),localStorage.setItem("font-size",size),localStorage.setItem("font",family)}function timeToHex(){var t=new Date,e=[];return e.hour=t.getHours(),e.min=t.getMinutes(),e.sec=t.getSeconds(),e.hour<=9&&(e.hour="0"+e.hour),e.min<=9&&(e.min="0"+e.min),e.sec<=9&&(e.sec="0"+e.sec),e}var use_storage=function(){try{return"localStorage"in window&&null!==window.localStorage}catch(t){return!1}};
function refreshData(){x=1,t=timeToHex();var e="#"+t.hour+t.min+t.sec;$("div.background").css({"background-color":e,transition:"all 0.5s"}),$("p#hex").text(e),$("fa-cog").css("-webkit-filter","invert(100%"),setTimeout(refreshData,x*precision)}function isOdd(t){return t%2}refreshData();
$(function(){function t(t,e,n){return Math.floor(Math.sqrt(Math.pow(e-(t.offset().left+t.width()/2),2)+Math.pow(n-(t.offset().top+t.height()/2),2)))}$.mobile.loading().hide(),console.log("Hex o’clock"),console.log("https://github.com/idleberg/hex-o-clock"),css=getData(),google_font=css.font.replace(" ","+"),font=getFontMetrics(css.font),$("#value-font-size").text(css["font-size"]+"em"),$("#value-invert").text(css.invert+"%"),$("#value-hue").text(css.hue+"°"),$("#value-saturate").text(css.saturate+"%"),$("#value-brightness").text(css.brightness+"%"),$("#value-contrast").text(css.contrast+"%"),$(".google-font").prop("href","http://fonts.googleapis.com/css?family="+google_font),$("#input-font-family").text(css.font),$("#input-font-size").val(css["font-size"]),$("#input-invert").val(css.invert),$("#input-hue").val(css.hue),$("#input-saturate").val(css.saturate),$("#input-brightness").val(css.brightness),$("#input-contrast").val(css.contrast),$("#input-font-family").val(css.font),$("#hex").css("font-size",css["font-size"]+"em"),$("#hex").css({"font-family":font.family+', Menlo, "Courier New", monospace',"font-weight":font.weight}),$("div.background").css("-webkit-filter","invert("+css.invert+"%) hue-rotate("+css.hue+"deg) saturate("+css.saturate+"%) brightness("+css.brightness+"%) contrast("+css.contrast+"%)"),$("body").fadeIn("fast"),$("#input-font-size").bind("mouseup mousemove keydown vmouseup vmousemove",function(){changeFont()}),$(".filter, .filter-label").bind("mouseup mousemove keydown vmouseup vmousemove",function(){changeFilter()}),$("#input-font-family").on("input",function(){changeFont()}),$("#label-font-size, #input").bind("dblclick taphold",function(){$("#value-font-size").text("12em"),invert=$("#input-font-size").val(12),changeFont()}),$("#label-invert, #input").bind("dblclick taphold",function(){$("#value-invert").text("0%"),invert=$("#input-invert").val(0),changeFilter()}),$("#label-hue, #input").bind("dblclick taphold",function(){$("#value-hue").text("0°"),hue_rotate=$("#input-hue").val(0),changeFilter()}),$("#label-saturate, #input").bind("dblclick taphold",function(){$("#value-saturate").text("100%"),saturate=$("#input-saturate").val(100),changeFilter()}),$("#label-brightness").bind("dblclick taphold",function(){$("#value-brightness").text("100%"),brightness=$("#input-brightness").val(100),changeFilter()}),$("#label-contrast, #input").bind("dblclick taphold",function(){$("#value-contrast").text("100%"),contrast=$("#input-contrast").val(100),changeFilter()}),$("#label-font-family, #input").bind("dblclick taphold",function(){saturate=$("#input-font-family").val("Lato:100"),changeFont()}),$(".background").bind("swipeleft",function(){$(".offcanvas").offcanvas("show")}),$(".background").bind("swiperight",function(){$(".offcanvas").offcanvas("hide")}),$(".close-menu").click(function(){$(".navmenu").offcanvas("hide")}),$(".toggle-menu").delay(5e3).fadeOut(5e3),$(document).mouseleave(function(){$(".toggle-menu").finish().fadeOut(2e3)});var e,n,o,s=$("#sweetspot");$(document).mousemove(function(a){e=a.pageX,n=a.pageY,o=t(s,e,n),500>=o?$(".toggle-menu").finish().fadeIn(200):$(".toggle-menu").fadeOut(5e3)}),$(".modal").on("show.bs.modal",function(){var t;t=this,$(".modal").each(function(){this!==t&&$(this).modal("hide")})}),$("#accordion").on("mouseenter.collapse","[data-toggle=collapse]",function(t){var e,n=$(this),o=n.attr("data-target")||t.preventDefault()||(e=n.attr("href"))&&e.replace(/.*(?=#[^\s]+$)/,""),s=$(o).hasClass("in")?"hide":"show";$(".panel-collapse").not(o).collapse("hide"),$(o).collapse(s)})});