...
function getData(){var e=[];if(e=setDefaults(),use_storage()){debug===!0&&console.info("	localStorage is available\n");for(var t=0;t<localStorage.length;t++){var o=localStorage.key(t),a=localStorage.getItem(o);e[o]=a,debug===!0&&console.log("	"+o+"="+a)}}return e}function setDefaults(){var e=[];return e.font="Lato:100",e["font-size"]="12",e["invert-percentage"]="0",e["hue-rotate"]="0",e.saturate="100",e}function getFontMetrics(e){var t=[];return e.indexOf(":")>-1?(font_array=e.split(":"),t.family=font_array[0],t.weight=font_array[1],t.google=e.replace(" ","+")):(t.family=e,t.weight="inherit",t.google=e.replace(" ","+")),t}function changeFilter(){invert=$("#inputInvert").val(),hue=$("#inputHue").val(),saturate=$("#inputSaturate").val(),debug===!0&&(console.log("Invert percentage changed to:	"+invert),console.log("Hue rotate changed to:	"+hue),console.log("Saturation changed to:	"+saturate)),$("div.background").css("-webkit-filter","invert("+invert+"%) hue-rotate("+hue+"deg) saturate("+saturate+"%)"),$("#valueInvert").text(invert+"%"),$("#valueHue").text(hue+"°"),$("#valueSaturate").text(saturate+"%"),localStorage.setItem("invert-percentage",invert),localStorage.setItem("hue-rotate",hue),localStorage.setItem("saturate",saturate)}function changeFont(){size=$("#inputFontSize").val(),family=$("#inputFontFamily").val(),font=getFontMetrics(family),$(".google-font").delay(1500).queue(function(e){$(this).prop("href","http://fonts.googleapis.com/css?family="+font.google),e()}),debug===!0&&(console.log("Font-family changed to:	"+family),console.log("Font-size changed to:	"+size)),$("#hex").css("font-size",size+"em"),$("#hex").css({"font-family":font.family+', Menlo, "Courier New", monospace',"font-weight":font.weight}),$("#valueFontSize").text(size+"em"),localStorage.setItem("font-size",size),localStorage.setItem("font",family)}function timeToHex(){var e=new Date,t=[];return t.hour=e.getHours(),t.min=e.getMinutes(),t.sec=e.getSeconds(),t.hour<=9&&(t.hour="0"+t.hour),t.min<=9&&(t.min="0"+t.min),t.sec<=9&&(t.sec="0"+t.sec),t}var use_storage=function(){try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}};
...
$(function(){function e(e,t,n){return Math.floor(Math.sqrt(Math.pow(t-(e.offset().left+e.width()/2),2)+Math.pow(n-(e.offset().top+e.height()/2),2)))}$.mobile.loading().hide(),console.log("Hex o’clock"),console.log("https://github.com/idleberg/hex-o-clock"),css=getData(),google_font=css.font.replace(" ","+"),font=getFontMetrics(css.font),$("#valueFontSize").text(css["font-size"]+"em"),$("#valueInvert").text(css["invert-percentage"]+"%"),$("#valueHue").text(css["hue-rotate"]+"°"),$("#valueSaturate").text(css.saturate+"%"),$(".google-font").prop("href","http://fonts.googleapis.com/css?family="+google_font),$("#inputFontFamily").text(css.font),$("#inputFontSize").val(css["font-size"]),$("#inputInvert").val(css["invert-percentage"]),$("#inputHue").val(css["hue-rotate"]),$("#inputSaturate").val(css.saturate),$("#inputFontFamily").val(css.font),$("#hex").css("font-size",css["font-size"]+"em"),$("#hex").css({"font-family":font.family+', Menlo, "Courier New", monospace',"font-weight":font.weight}),$("div.background").css("-webkit-filter","invert("+css["invert-percentage"]+"%) hue-rotate("+css["hue-rotate"]+"deg) saturate("+css.saturate+"%)"),$("body").fadeIn("fast"),$("#inputFontSize").bind("mouseup mousemove keydown vmouseup vmousemove",function(){changeFont()}),$(".filter, .filter-label").bind("mouseup mousemove keydown vmouseup vmousemove",function(){changeFilter()}),$("#inputFontFamily").on("input",function(){changeFont()}),$("#labelFontSize").bind("dblclick taphold",function(){$("#valueFontSize").text("12em"),invert=$("#inputFontSize").val(12),changeFont()}),$("#labelInvert").bind("dblclick taphold",function(){$("#valueInvert").text("0%"),invert=$("#inputInvert").val(0),changeFilter()}),$("#labelHue").bind("dblclick taphold",function(){$("#valueHue").text("0°"),hue_rotate=$("#inputHue").val(0),changeFilter()}),$("#labelSaturate").bind("dblclick taphold",function(){$("#valueSaturate").text("100%"),saturate=$("#inputSaturate").val(100),changeFilter()}),$("#labelFontFamily").bind("dblclick taphold",function(){saturate=$("#inputFontFamily").val("Lato:100"),changeFont()}),$(".background").bind("swipeleft",function(){$(".offcanvas").offcanvas("show")}),$(".background").bind("swiperight",function(){$(".offcanvas").offcanvas("hide")}),$(".close-menu").click(function(){$(".navmenu").offcanvas("hide")}),$(".toggle-menu").delay(5e3).fadeOut(5e3),$(document).mouseleave(function(){$(".toggle-menu").finish().fadeOut(2e3)});var t,n,o,a=$("#sweetspot");$(document).mousemove(function(i){t=i.pageX,n=i.pageY,o=e(a,t,n),500>=o?$(".toggle-menu").finish().fadeIn(200):$(".toggle-menu").fadeOut(5e3)}),$(".modal").on("show.bs.modal",function(){var e;e=this,$(".modal").each(function(){this!==e&&$(this).modal("hide")})})});